...
{                                          // **Transforms_Sandbox_Base** is a Scene that can be added to any display canvas.
    ...
    for(var i = 0; i < 36; i+= 1) {
      if (i % 2 == 0) {
        if(this.time_of_day == "day") {
          ...
          this.shapes.tree_trunk.draw(context, program_state, model_transform.times(Mat4.translation(...g_origin_offset)).times(Mat4.translation(this.random_x[i], 0.5, this.random_z[i])), this.materials.tree_trunk.override({ambient: 0.3}));
          this.shapes.tree_leaves.draw(context, program_state, model_transform.times(Mat4.translation(...g_origin_offset)).times(Mat4.translation(this.random_x[i], 1.4, this.random_z[i])), this.materials.tree_leaves.override({ambient: 0.3}));
        }
      }else{
        if(this.time_of_day == "day")
          ...
          this.shapes.rock.draw(context, program_state, model_transform.times(Mat4.translation(...g_origin_offset)).times(Mat4.translation(this.random_x[i], -1, this.random_z[i])), this.materials.rock.override({ambient: 0.5}));
      }
    }
  }
  ...
  draw_pond(context, program_state, model_transform) {
    ...
    //Draw walls
    if (this.time_of_day == "day") {
      this.shapes.wall.draw(context, program_state, model_transform.times(Mat4.translation(...g_origin_offset)).times(Mat4.scale(4, 0.5, 0.2)).times(Mat4.translation(-1.5, -4.0, -9.8)), this.materials.rock);
      this.shapes.wall.draw(context, program_state, model_transform.times(Mat4.translation(...g_origin_offset)).times(Mat4.rotation(Math.PI / 2, 0, 1, 0)).times(Mat4.scale(4, 0.5, 0.2)).times(Mat4.translation(1.44, -4.0, -9)), this.materials.rock);
      this.shapes.wall.draw(context, program_state, model_transform.times(Mat4.translation(...g_origin_offset)).times(Mat4.scale(4.2, 0.5, 0.2)).times(Mat4.translation(-1.4, -4.0, -49.8)), this.materials.rock);
      this.shapes.wall.draw(context, program_state, model_transform.times(Mat4.translation(...g_origin_offset)).times(Mat4.rotation(Math.PI / 2, 0, 1, 0)).times(Mat4.scale(4, 0.5, 0.2)).times(Mat4.translation(1.44, -4.0, -49.5)), this.materials.rock);
    }else{
      this.shapes.wall.draw(context, program_state, model_transform.times(Mat4.translation(...g_origin_offset)).times(Mat4.scale(4, 0.5, 0.2)).times(Mat4.translation(-1.5, -4.0, -9.8)), this.materials.rock.override({ambient: 0.5}));
      this.shapes.wall.draw(context, program_state, model_transform.times(Mat4.translation(...g_origin_offset)).times(Mat4.rotation(Math.PI / 2, 0, 1, 0)).times(Mat4.scale(4, 0.5, 0.2)).times(Mat4.translation(1.44, -4.0, -9)), this.materials.rock.override({ambient: 0.5}));
      this.shapes.wall.draw(context, program_state, model_transform.times(Mat4.translation(...g_origin_offset)).times(Mat4.scale(4.2, 0.5, 0.2)).times(Mat4.translation(-1.4, -4.0, -49.8)), this.materials.rock.override({ambient: 0.5}));
      this.shapes.wall.draw(context, program_state, model_transform.times(Mat4.translation(...g_origin_offset)).times(Mat4.rotation(Math.PI / 2, 0, 1, 0)).times(Mat4.scale(4, 0.5, 0.2)).times(Mat4.translation(1.44, -4.0, -49.5)), this.materials.rock.override({ambient: 0.5}));
    }
  }
  ...
  draw_boundary(context, program_state, model_transform){
    ...
    for(var theta = 0; theta < 2*Math.PI; theta+= 0.05){
      if(theta >= 0 && theta < Math.PI/2) {
        if(this.time_of_day == "day")
          this.shapes.fence.draw(context, program_state, model_transform.times(Mat4.translation(...g_origin_offset)).times(Mat4.translation(0, -1, 0)).times(Mat4.translation(R * Math.cos(theta), 0, R * Math.sin(theta))).times(Mat4.rotation(Math.PI / 2 - theta, 0, 1, 0)).times(Mat4.scale(0.77, 0.77, 0.77)), this.materials.tree_trunk)
        else
          this.shapes.fence.draw(context, program_state, model_transform.times(Mat4.translation(...g_origin_offset)).times(Mat4.translation(0, -1, 0)).times(Mat4.translation(R * Math.cos(theta), 0, R * Math.sin(theta))).times(Mat4.rotation(Math.PI / 2 - theta, 0, 1, 0)).times(Mat4.scale(0.77, 0.77, 0.77)), this.materials.tree_trunk.override({ambient: 0.1}))
      }else if(theta >= Math.PI/2 && theta < Math.PI) {
        if(this.time_of_day == "day")
          this.shapes.fence.draw(context, program_state, model_transform.times(Mat4.translation(...g_origin_offset)).times(Mat4.translation(0, -1, 0)).times(Mat4.translation(R * Math.cos(theta), 0, R * Math.sin(theta))).times(Mat4.rotation(Math.PI / 2 + Math.PI - theta, 0, 1, 0)).times(Mat4.scale(0.77, 0.77, 0.77)), this.materials.tree_trunk)
        else
          this.shapes.fence.draw(context, program_state, model_transform.times(Mat4.translation(...g_origin_offset)).times(Mat4.translation(0, -1, 0)).times(Mat4.translation(R * Math.cos(theta), 0, R * Math.sin(theta))).times(Mat4.rotation(Math.PI / 2 + Math.PI - theta, 0, 1, 0)).times(Mat4.scale(0.77, 0.77, 0.77)), this.materials.tree_trunk.override({ambient: 0.1}))
      }else if(theta >= Math.PI && theta < 3*Math.PI/2) {
        if(this.time_of_day == "day")
          this.shapes.fence.draw(context, program_state, model_transform.times(Mat4.translation(...g_origin_offset)).times(Mat4.translation(0, -1, 0)).times(Mat4.translation(R * Math.cos(theta), 0, R * Math.sin(theta))).times(Mat4.rotation(3 * Math.PI / 2 + Math.PI - theta, 0, 1, 0)).times(Mat4.scale(0.77, 0.77, 0.77)), this.materials.tree_trunk)
        else
          this.shapes.fence.draw(context, program_state, model_transform.times(Mat4.translation(...g_origin_offset)).times(Mat4.translation(0, -1, 0)).times(Mat4.translation(R * Math.cos(theta), 0, R * Math.sin(theta))).times(Mat4.rotation(3 * Math.PI / 2 + Math.PI - theta, 0, 1, 0)).times(Mat4.scale(0.77, 0.77, 0.77)), this.materials.tree_trunk.override({ambient: 0.1}))
      }
      else {
        if(this.time_of_day == "day")
          this.shapes.fence.draw(context, program_state, model_transform.times(Mat4.translation(...g_origin_offset)).times(Mat4.translation(0, -1, 0)).times(Mat4.translation(R * Math.cos(theta), 0, R * Math.sin(theta))).times(Mat4.rotation(2 * Math.PI + 3 * Math.PI / 2 - theta, 0, 1, 0)).times(Mat4.scale(0.77, 0.77, 0.77)), this.materials.tree_trunk)
        else
          this.shapes.fence.draw(context, program_state, model_transform.times(Mat4.translation(...g_origin_offset)).times(Mat4.translation(0, -1, 0)).times(Mat4.translation(R * Math.cos(theta), 0, R * Math.sin(theta))).times(Mat4.rotation(2 * Math.PI + 3 * Math.PI / 2 - theta, 0, 1, 0)).times(Mat4.scale(0.77, 0.77, 0.77)), this.materials.tree_trunk.override({ambient: 0.1}))
  ...
  draw_environment(context, program_state, model_transform) {
      if(this.time_of_day == "day") {
          ...
          this.shapes.ground.draw(context, program_state, model_transform
              ...
              .times(Mat4.rotation(Math.PI / 2, 1, 0, 0))
              .times(Mat4.translation(0, 0, 2))
              .times(Mat4.scale(50, 50, 0.5)), this.materials.ground.override({ambient: 0.3}));
      }
      if(this.time_of_day == "day") {
          ...
          this.shapes.skybox.draw(context, program_state, model_transform
              .times(Mat4.translation(...g_origin_offset))
              .times(Mat4.rotation(Math.PI / 2, 1, 0, 0))
              .times(Mat4.scale(60, 60, 60)), this.materials.night_sky);
      }
